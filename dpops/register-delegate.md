...
{% hint style="info" %}
If you installed the program through with [the auto-installer](node-installation.md#quick-installation) and chose to create a new block verifier key, you should have saved it at the end of the installation already. You don't need to generate a new one and can go[ register yourself as a delegate ](register-delegate.md#2-register-yourself-as-a-delegate)directly.
{% endhint %}
