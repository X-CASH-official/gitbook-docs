...
![ Figure 1 - high-level view of a generic realization of DPoS consensus in a blockchain](../.gitbook/assets/0.png)
...
![ Figure 2 - a reserve proof created by a network participant enables staking without giving away the private key](../.gitbook/assets/1%20%281%29.png)
...
![Figure 3 - regular round robin block production scheduling, where a block producer missing block creation is picked up by the next block producer](../.gitbook/assets/2.png)
...
![Figure 6 : decentralized database &#x2013; reserve proof collection syncing process](../.gitbook/assets/5.png)
...
![Figure 9 : decentralized database &#x2013; reserve proof verification process](../.gitbook/assets/8.png)
...
![Figure 10 : survival probability of an invalid reserve proof overtime](../.gitbook/assets/9%20%281%29.png)
...
More info about the VRF integration can be found in the VRF functions section of X-Cash DPoPS on Github[\[1\]](%20https://github.com/X-CASH-official/XCASH_proof_of_stake/tree/master/functions/VRF_functions).
...
![Figure 13 : block content and its link to reserve bytes data in the decentralized database](../.gitbook/assets/12.png)
...
![ Figure 14 : daemon &#x2013; syncing process](../.gitbook/assets/13.jpeg)
...
The purpose of this section is to describe the primary components and purposes of these templates. More details can be found in the dedicated section of the DPoPS Github[\[2\]]().
...
![ Figure 15 : data transmission protocol &#x2013; overview of templates](../.gitbook/assets/14.png)
...
| \[6\] | "Byzantine fault," Wikipedia, \[Online\]. Available: https://en.wikipedia.org/wiki/Byzantine\_fault. |
| \[7\] | "pEOS Whitepaper - Private, untraceable transactions on EOS," pEOS, \[Online\]. Available: https://peos.one/docs/pEOS\_whitepaper\_rev1\_1.pdf. |
...
| \[10\] | "ENIGMA - A private, secure and untraceable transaction system for cloack," Cloack, \[Online\]. Available: https://www.cloakcoin.com/user/themes/g5\_cloak/resources/CloakCoin\_Whitepaper\_v2.1.pdf. |
| \[11\] | "get\_reserve\_proof," Monero, \[Online\]. Available: https://www.getmonero.org/resources/developer-guides/wallet-rpc.html\#get\_reserve\_proof. |
...
| \[13\] | "aelf - A Multi-Chain Parallel Computing," aelf, 07 06 2018. \[Online\]. Available: https://aelf.io/gridcn/aelf\_whitepaper\_EN.pdf?v=1.6. |
